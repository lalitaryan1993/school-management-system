    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{ ($prefix == '/employees') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            <li class="{{ $route == 'employee.registration.view' ? 'active' : '' }}"><a href="{{ route('employee.registration.view')}}"><i class="ti-more"></i>Employees Registration</a></li>
            <li class="{{ $route == 'employee.salary.view' ? 'active' : '' }}"><a href="{{ route('employee.salary.view')}}"><i class="ti-more"></i>Employees Salary</a></li>
            <li class="{{ $route == 'employee.leave.view' ? 'active' : '' }}"><a href="{{ route('employee.leave.view')}}"><i class="ti-more"></i>Employees Leave</a></li>
            <li class="{{ $route == 'employee.attendance.view' ? 'active' : '' }}"><a href="{{ route('employee.attendance.view')}}"><i class="ti-more"></i>Employees Attendance</a></li>
            <li class="{{ $route == 'monthly.salary.view' ? 'active' : '' }}"><a href="{{ route('monthly.salary.view')}}"><i class="ti-more"></i>Employees Monthly Salary</a></li>
        ...
        <li class="treeview {{ ($prefix == '/marks') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            <li class="{{ $route == 'marks.entry.view' ? 'active' : '' }}"><a href="{{ route('marks.entry.view')}}"><i class="ti-more"></i>Marks Entry</a></li>
