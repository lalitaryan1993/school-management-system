        ...
        <!-- Basic Forms -->
         <div class="box">
           ...
           <div class="box-body">
             <div class="row">
               <div class="col">
                   <form action="{{ route('student.registration.promote', [$editData->student_id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <input type="hidden" name="id" value="{{ $editData->id }}"/>
                     <div class="row">
                       ...
                       <div class="text-xs-right">
                           <button type="submit" name="submit" class="btn btn-rounded btn-info">Promotion</button>
                       </div>
                   </form>
